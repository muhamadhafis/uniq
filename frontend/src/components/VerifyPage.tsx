...
export default function VerifyPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-12 lg:gap-24">
      {/* Search Section */}
      <div className="w-full md:w-1/2 flex flex-col space-y-8 pt-8">
        <div>
        ...
        <div className="double-bezel mt-8">
          <div className="double-bezel-inner p-2 flex items-center">
            ...
            >
              <ArrowRight weight="bold" size={18} className="transition-transform duration-500 group-hover:translate-x-0.5" />
            </button>
          </div>
        </div>
      </div>
